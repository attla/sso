				...
				<div class="col">
					<div class="group-content">
						...
						<div class="text-center">
							<span>Deseja entrar com outra conta? <a href="@route(config('sso.route-group.as') . 'login', ['token' => $token])" tabindex="4">Trocar de conta</a>.</span>
						</div>
					</div>
				</div>
			</div>
